...
test("Can create a simple form and extract values", () => {
    ...
    form.addChild(new FormParameter(form, {
        id: "name",
    ...
    form.addChild(new FormSection(form, {
        id: "more_questions",
        label: "Some more questions"
    }));
    expect(form.getSection("more_questions").path).toBe("more_questions");

    form.getSection("more_questions").addChild(new FormParameter(form, {
        id: "color",
...
test("Validate IDs and paths", () => {
    ...
    expect(() => {
        subFormInner.addChild(new FormParameter(form, {
            id: "testparam",
