...
module.exports = {
    ...
    createConfig: (projectName, tsconfig, overrides) => {
        ...
        // Force usage of the CommonJS version of Fluent UI since Jest
        // currently doesn't support ES modules
        baseConfig.moduleNameMapper["office-ui-fabric-react/lib/(.*)$"] = "office-ui-fabric-react/lib-commonjs/$1";
        baseConfig.moduleNameMapper["@fluentui/react/lib/(.*)$"] = "@fluentui/react/lib-commonjs/$1";
